...
abstract class AppColors {
  // Light Theme Colors
  static const Color lightPrimary = Color(0xFFE8000D);
  static const Color lightSecondary = Color(0xFFB20009);
  static const Color lightOnSurfaceVariant = Color(0xFF9FA5C0);
  static const Color lightOutline = Color(0xFFFFBABA);
  static const Color lightScaffoldBackground = Color(0xFFffffff);
  static const Color lightDialogBackground = Color(0xFFF0F0F0);
  static const Color lightMainTextColor = Color(0xFF1A0000);
  ...
  // Dark Theme Colors
  static const Color darkPrimary = Color(0xFFDB3022);
  static const Color darkSecondary = Color(0xFFB20009);
  ...
  static const Color darkMainTextColor = Color(0xFFFFF5F5);
